...
dict_file = load_dictionary.loadfile('2of4brif.txt')
# ensure "a" & "I" (both lowercase) are included (single character words)
dict_file.append('a')
dict_file.append('i')
...
def process_choice(name):
    """ Check user's choice for validity, return choice & leftover letters """
    while True:
...
def main():
    """ Help user to build anagram phrase from their name """
