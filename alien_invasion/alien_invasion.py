...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Enable full screen mode (if you want)
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # if all aliens destroied, create a new alien fleet
        if not self.aliens:
    ...
    def _create_fleet(self):
        ...
        # Create an alien 
        #  Only for calculation purpose, this alien would be included into fleet
        alien = Alien(self)
        ...
        number_rows = available_space_y // (alien_height + 15)
        ...
        for row_number in range(number_rows):
            for alien_number in range(number_alien_x):
                ...
                self._create_alien(alien_width + 2 * alien_width * alien_number,
                                alien_height + (alien_height + 15) * row_number)
    ...
    def _update_aliens(self):
        ...
        # Call the method Update on the Group will calls each alien's update() method
        self.aliens.update()
